    ...
    if (Array.isArray(data)) {
        ...
        data.forEach(item => {
            ...
            row.innerHTML = `
                ...
                <td>${item.plan.value - item.payment.discount}</td>
                <td style="padding: 0%;">
                    <button onclick="insertDataStudentByID(${item.id}, 'info')" data-target="modal-generic" class="waves-effect waves-light btn blue btn-opcoes modal-trigger">
                    ...
                    <button onclick="insertDataStudentByID(${item.id}, 'edit')" data-target="modal-generic" class="waves-effect waves-light btn green btn-opcoes modal-trigger">
                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" style="vertical-align: middle;" 
                            viewBox="0 0 24 24" width="24px" fill="#e8eaed">
                            <path d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <button data-target="modal-delete${item.id}" class="waves-effect waves-light btn red btn-opcoes modal-trigger">
                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" style="vertical-align: middle;" 
                             viewBox="0 0 24 24" width="24px" fill="#e8eaed">
                            <path d="M0 0h24v24H0z" fill="none"/>
